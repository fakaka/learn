...
final class HttpHeader {
	...
	/**
	 * Test if the name of the header is equal to the given string. The String given
	 * must be made of lower case characters.
	 */
	...
	/**
	 * Test if the name and value of the header is equal to the given header. All
	 * the characters in the name must already be lower case.
	 */
