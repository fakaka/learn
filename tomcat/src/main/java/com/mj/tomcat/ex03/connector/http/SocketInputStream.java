...
public class SocketInputStream extends InputStream {
	...
	/**
	 * Read the request line, and copies it to the given buffer. This function is
	 * meant to be used during the HTTP request header parsing. Do NOT attempt to
	...
	/**
	 * Read a header, and copies it to the given buffer. This function is meant to
	 * be used during the HTTP request header parsing. Do NOT attempt to read the
	 * request body using it.
	 *
	 * @param requestLine
	 *            Request line object
	 * @throws IOException
