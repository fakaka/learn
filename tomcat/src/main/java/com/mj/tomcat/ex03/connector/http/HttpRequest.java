...
import com.mj.tomcat.ex03.connector.RequestStream;
...
public class HttpRequest implements HttpServletRequest {
	...
	/**
	 * An empty collection to use for returning empty Enumerations. Do not add any
	...
	/**
	 * The HTTP headers associated with this Request, keyed by name. The values are
	 * ArrayLists of the corresponding header values.
	 */
	 ...
	 * information is requested via one of the <code>getParameter()</code> family of
	 * method calls. The key is the parameter name, while the value is a String
	 * array of values for this parameter.
	 * <p>
	 * <strong>IMPLEMENTATION NOTE</strong> - Once the parameters for a particular
	 * request are parsed and stored here, they are not modified. Therefore,
	 * application level access to the parameters need not be synchronized.
	 */
	 ...
	 * parameters are present in both the query string and the request content, they
	 * are merged.
	 */
	...
	/**
	 * Create and return a ServletInputStream to read the content associated with
