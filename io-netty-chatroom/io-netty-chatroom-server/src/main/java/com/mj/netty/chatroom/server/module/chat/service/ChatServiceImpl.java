...
import com.mj.netty.chatroom.common.core.exception.ErrorCodeException;
...
import com.mj.netty.chatroom.common.module.chat.response.ChatType;
import com.mj.netty.chatroom.server.module.player.dao.PlayerDao;
...
public class ChatServiceImpl implements ChatService {
	...
	public void privateChat(long playerId, long targetPlayerId, String content) {
		...
		//判断对方是否在线
		if (!SessionManager.isPlayerOnline(targetPlayerId)) {
